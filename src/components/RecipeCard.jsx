...
export default function RecipeCard({
  ...
  return (
    <Card className="h-[400px] text-left rounded-2xl overflow-hidden shadow-md transition hover:shadow-lg group pt-0 transition-all duration-700 hover:-translate-y-2.5">
